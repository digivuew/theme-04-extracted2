...
export const metadata = {
  title:
    "Home 18 || Personal Portfolio React Nextjs Template | Freelancer & Developer Portfolio",
  description:
                  ...
                  <div className="position-sticky sticky-top tmp-sticky-top w-100">
                    <div className="tmp-contact-about-inner">
                      <div className="thumbnail">
                        ...
                        {/* Previously: /assets/images/banner/banner-user-image-05.png */}
                      </div>
                      <div className="content">
                        <div className="title-area">
                          <h4 className="title">Lina Markar</h4>
